...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const doc: CampaignDocument = {
            ...
            stripeCouponId: body.stripeCouponId || undefined,
...
export async function PUT(req: NextRequest) {
    ...
    try {
        ...
        const update: Partial<CampaignDocument> = {
            ...
            couponCode: rest.couponCode || undefined,
            stripeCouponId: rest.stripeCouponId || undefined,
            firstTimeOnly: rest.firstTimeOnly === true,
